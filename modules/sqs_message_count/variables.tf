 ...
 */
variable "threshold" {
  description = "Critical threshold: number of visible messages to trigger an alert"
  type        = number
...
variable "warning_threshold" {
  description = "Warning threshold: number of visible messages to trigger a warning"
  type        = number
